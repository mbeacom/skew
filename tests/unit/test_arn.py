...
class TestARN(unittest.TestCase):
    ...
    def test_sns(self):
        ...
        arn = scan("arn:aws:sns:us-east-1:123456789012:topic/*", **placebo_cfg)
        l = list(arn)
        self.assertEqual(len(l), 1)
    ...
    def test_sqs_queue(self):
        ...
        arn = scan("arn:aws:sqs:us-east-1:123456789012:queue/*", **placebo_cfg)
        l = list(arn)
        self.assertEqual(len(l), 1)
    ...
    def test_elasticbeanstalk_application(self):
        ...
        arn = scan("arn:aws:elasticbeanstalk:us-east-1:123456789012:application/*", **placebo_cfg)
        l = list(arn)
        self.assertEqual(len(l), 1)
        self.assertEqual(
            l[0].arn,
            "arn:aws:elasticbeanstalk:us-east-1:123456789012:application/super-app",
        )
        self.assertEqual(l[0].tags["Env"], "Production")
        self.assertEqual(l[0].tags["Project"], "Marketing")
    ...
    def test_rds_sec_grp(self):
        ...
        arn = scan("arn:aws:rds:us-east-1:123456789012:secgrp/*", **placebo_cfg)
        l = list(arn)
        self.assertEqual(len(l), 1)
    ...
    def test_firehose(self):
        ...
        arn = scan("arn:aws:firehose:us-east-1:123456789012:deliverystream/*", **placebo_cfg)
        l = list(arn)
        self.assertEqual(len(l), 1)
        self.assertEqual(
            l[0].arn,
            "arn:aws:firehose:us-east-1:123456789012:deliverystream/delivery-stream-1",
        )
        self.assertEqual(l[0].tags["Env"], "Production")
        self.assertEqual(l[0].tags["Project"], "Marketing")
